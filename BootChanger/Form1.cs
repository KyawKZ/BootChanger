...
namespace BootChanger
{
    public partial class Form1 : Form
    {
        ...
        {
            richTextBox1.AppendText("Mounting EFI System Partition : ", Color.Yellow);
            try
            {
        ...
        {
            richTextBox1.AppendText("Scanning Bootloaders : ", Color.Yellow);
            ...
            {
                if(dir!="Boot" && dir!="CLOVER" && dir!="Opencore" && dir != "Microsoft")
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                g = "/c bcdedit /set {bootmgr} path EFI\\Opencore\\Opencore.efi";
            }
